...
<!--   src="/figs/2023_BeS_fig6.png"/> {% capture _title %} {%-reference -->
...
<!--   box-peanut bulges.  </figure> <p id="img-caption"></figure> </div> <\!-- -->
<!--   -------------------------------------------------- -\-> -->
...
<figure style="float: left; margin: 0px 15px 0px 0;">
  <img src="/figs/2023_BeS_fig6.png" width="450" alt="">
...
<!-- Margins: TOP RIGHT BOTTOM LEFT -->
<figure style="float: right; margin: 0px 0px 0px 15px;"> <img
  src="/figs/2023_Wheeler_fig1.png" width="480" alt=""> </figure>
  
  por Wheeler et al. (2023), onde mostramos que barras galácticas
  podem crescer pacificamente e se estabilizarem na presença de um
...
### [Bending waves excited by irregular gas inflow along warps](https://ui.adsabs.harvard.edu/abs/2022MNRAS.512.3500K/abstract),
</div>
<!-- Margins: TOP RIGHT BOTTOM LEFT -->
<figure style="float: center; margin: 0px 15px 0px 0;"> <img
  src="/figs/2022_Khachaturyants_fig6.png" width="820" alt=""> </figure>
  
  por Khachaturyants et al. (2022), onde mostramos que ondas de flexão
  ("bending waves") prógradas em discos galácticos podem ser
  produzidas por acreção desalinhada de gás, e que esta é uma possível
  fonte de perturbações verticais no disco da Via Láctea.
  <div style="clear: both;"></div>

---
<div class="header-left">

### [Co-formation of the thin and thick discs revealed by APOGEE-DR16 and Gaia-DR2](https://ui.adsabs.harvard.edu/abs/2021MNRAS.502..260B/abstract),
</div>
<!-- Margins: TOP RIGHT BOTTOM LEFT -->
<figure style="float: right; margin: 0px 0px 0px 15px;"> <img
  src="/figs/2021_BeS_fig1.png" width="400" alt=""> </figure>
  
  por Beraldo e Silva et al. (2021), onde encontramos evidências de um
disco fino antigo na Via Láctea, e mostramos que uma grande população
de estrelas velhas produz três picos na distribuição de raios de
pericentro. O pico mais externo ($r_\mathrm{per}\approx 7$ kpc) é
produzido pela migração radial de estrelas de ambos o disco fino e
espesso. <div style="clear: both;"></div>
  
---
<div class="header-center">

### [Geometric properties of galactic discs with clumpy episodes](https://ui.adsabs.harvard.edu/abs/2020MNRAS.492.4716B/abstract),
</div>
<!-- Margins: TOP RIGHT BOTTOM LEFT -->
<figure style="float: center; margin: 0px 15px 0px 0px;"> <img
  src="/figs/2020_BeS_fig4.png" width="820" alt=""> </figure>
  
  por Beraldo e Silva et al. (2020), onde mostramos que discos
